...
object AutoUpdater {
    ...
    private const val GITHUB_LATEST_RELEASE_URL = "https://api.github.com/repos/GRT47/CarrotNavi_Client/releases/latest"
    ...
    private fun downloadAndInstall(context: Context, downloadUrl: String, version: String) {
        ...
        val fileName = "CarrotNaviClient_$version.apk"
        ...
        val request = DownloadManager.Request(Uri.parse(downloadUrl))
            .setTitle("CarrotNavi Client 업데이트 다운로드 중")
